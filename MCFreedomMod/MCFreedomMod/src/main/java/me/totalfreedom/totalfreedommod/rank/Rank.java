...
public enum Rank implements Displayable
{
    ...
    MASTER_BUILDER("the", "Master Builder", Type.PLAYER, "MB", ChatColor.LIGHT_PURPLE),
    TRIAL_ADMIN("a", "Trial Admin", Type.ADMIN, "TA", ChatColor.DARK_AQUA),
    ...
    EPIC_FACE32301("the", "Founder", Type.ADMIN, "Founder", ChatColor.DARK_BLUE),
    TELNET_CONSOLE("the", "Console", Type.ADMIN_CONSOLE, "Console", ChatColor.DARK_GREEN),
    SENIOR_CONSOLE("the", "Console", Type.ADMIN_CONSOLE, "Console", ChatColor.GOLD),
    EXECUTIVE_CONSOLE("the", "Console", Type.ADMIN_CONSOLE, "Console", ChatColor.DARK_RED);
    @Getter
