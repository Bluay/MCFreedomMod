...
@CommandParameters(description="Punishing players", usage="/<command> <playername>")
public class Command_punish extends FreedomCommand
{
  @Override
  public boolean run(final CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
  {
    ...
    player.sendMessage(ChatColor.DARK_RED + "You've been punished");
