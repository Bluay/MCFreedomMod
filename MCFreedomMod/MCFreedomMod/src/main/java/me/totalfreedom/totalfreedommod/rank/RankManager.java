...
public class RankManager extends FreedomService
{
    ...
    public Displayable getDisplay(CommandSender sender)
    {
        ...
        {
            return Title.SERVER_MANAGER;
        }
           if (ConfigEntry.SERVER_LEAD_DEVELOPERS.getList().contains(player.getName()))
        {
            ...
            if (ConfigEntry.SERVER_DEVELOPERS.getList().contains(player.getName()))
        {
            return Title.DEV;
                ...
                if (ConfigEntry.SERVER_DONATORS.getList().contains(player.getName()))
        {
