...
@CommandPermissions(level = Rank.TRIAL_ADMIN, source = SourceType.ONLY_IN_GAME)
@CommandParameters(description = "Admin tool kit", usage = "/<command>", aliases = "at")
public class Command_admintools extends FreedomCommand
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        blockItem.setItemMeta(blockItemMeta);
             ...
             sender_p.sendMessage(ChatColor.RED + "Admin tools has been placed into your inventory");
        return true;
            }
 }