...
@CommandParameters(description = "Mutes admins with brute force.", usage = "/<command> [[-s] <player> [reason] | list | purge | all]", aliases = "silent")
public class Command_silence extends FreedomCommand
{
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        {
            FUtil.adminAction(sender.getName(), "Silencing all players", true);
        ...
        else
        {
            ...
            FUtil.adminAction(sender.getName(), "Silencing " + player.getName(), true);
            playerdata.setMuted(true);
            player.setOp(false);
            if (smite)
            {
